...
A fully offline, privacy-first AI chatbot with PDF document intelligence.
Built with Node.js, React, and Ollama — no cloud, no API keys, no data leaving your machine.
...
├── server/
│   ├── src/
│   │   └── index.js       # Express API, RAG pipeline, SSE streaming
│   └── package.json
└── web/
├── src/
